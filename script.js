    ...
    data.forEach((movie) => {
        ...
        movieEl.innerHTML = `
            ...
            <div class="overview">
                ...
                <br/> 
                <button class="know-more" id="${id}">Know More</button>
                <button class="watchlist-btn" id="watchlist-${id}">Add to Watchlist</button>
            </div>
        `;
        ...
        const watchlistButton = document.getElementById(`watchlist-${id}`);
...
let watchlist = []; // Initialize an empty array to store the watchlist movies
...
function displayWatchlist() {
    ...
    watchlistEl.innerHTML = ''; // Clear the current watchlist
    ...
    watchlist.forEach((movie) => {
        ...
        watchlistItem.innerHTML = `
            ...
            <h3>${title}</h3>
        `;
        watchlistEl.appendChild(watchlistItem);
    });

    // Add styles to display the watchlist in a row
    const watchlistContainer = document.getElementById("watchlist");
    watchlistContainer.style.display = "flex";
    watchlistContainer.style.flexWrap = "wrap";
    watchlistContainer.style.gap = "10px";
}
